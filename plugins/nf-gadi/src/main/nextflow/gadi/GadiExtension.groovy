...
@Slf4j
@CompileStatic
class GadiExtension extends PluginExtensionPoint {
    ...
    /*
     * A Custom config extracted from nextflow.config under gadi tag
     * nextflow.config
     * ---------------
     * docker{
     *   enabled = true
    ...
    protected void init(Session session) {
        ...
        this.config = new GadiConfig(session.config.navigate('gadi') as Map)
    }
