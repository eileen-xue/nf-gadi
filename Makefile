...
version ?= $(shell grep 'Plugin-Version' plugins/nf-gadi/src/resources/META-INF/MANIFEST.MF | awk '{ print $$2 }')
...
install:
	...
	rm -rf ${HOME}/.nextflow/plugins/nf-gadi-${version}
	cp -r build/plugins/nf-gadi-${version} ${HOME}/.nextflow/plugins/
